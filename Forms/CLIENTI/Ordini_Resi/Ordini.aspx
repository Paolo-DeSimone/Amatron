        ...
        <div class="card mb-3 ordini">
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">
                            <asp:Label ID="lblTitoloProdotto" runat="server" Text="Label">Samsung Galaxy S23, Caricatore incluso</asp:Label></h5>
                        <p class="card-text">
                            <asp:Label ID="lblDescrizione" runat="server" Text="Label">Smartphone Android, Display 6.1'' Dynamic AMOLED 2X, Fotocamera 50MP</asp:Label></p>
                        <%-- pulsante che apre il popup --%>
