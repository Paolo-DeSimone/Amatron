                ...
                <div class="card-header">            
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <p style="color: black"><asp:Literal ID="litDataRecensione" runat="server" Text="Recensito il 3 Febbraio 2023"></asp:Literal></p>
                        </div>
                         <hr style="margin:5px" />
                        <p style="color: black"><asp:Literal ID="litRecensione" runat="server" Text="Figo bello 5 stelle"></asp:Literal></p>
                    </div>
                </div>
                ...
                <div class="card-header">
                    <div class="card-body">
                        ...
                        <div>
                         ...
                         <hr style="margin:5px" />
                        <p style="color: black"><asp:Literal ID="Literal2" runat="server" Text="Assurdo e pazzesco"></asp:Literal></p>
                    </div>
                </div>
