...
public partial class Venditori_AggiungiProdotti : System.Web.UI.Page
{
    ...
    protected void btnSalva_Click(object sender, EventArgs e)
    {
        ...
        if (txtDescrizione.Text.Trim() == "" || txtPrezzo.Text.Trim() == "")
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "error", "notifyError('Dati mancanti');", true);
            return;
        ...
        ScriptManager.RegisterStartupScript(this, this.GetType(), "closePopupAggiungiProdotto", "window.parent.location.href='/Forms/VENDITORI/VisualizzaProdotti.aspx';", true);
    }
