                    ...
                    <div class=" col-md-6 ">
                        <div class="card cardIncard">
                            <div class="row">
                                ...
                                <div class="col-md-6 allineato">
                                    <h4>
                                        <asp:Label ID="Label1" runat="server" Text="TITOLO 2"></asp:Label></h4>
                                    <h4>
                                        <asp:Label ID="Label2" runat="server" Text="PREZZO 2"></asp:Label></h4>
                                    <h5>
                                        <asp:Label ID="Label3" runat="server" Text="CATEGORIA 2"></asp:Label>
                                    </h5>
                                    <asp:Label ID="Label4" runat="server" Text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque elementum libero porttitor purus accumsan,
                            eget ultrices metus aliquet. Aliquam non ornare nulla. Aliquam et sollicitudin diam, malesuada lacinia enim. Integer at nibh tempus, lacinia diam auctor, vulputate augue. 
                            Proin faucibus pharetra ante eget pharetra. Mauris lacinia libero consequat, sagittis purus. "
                                        class="DescrizioneProdotto"></asp:Label>
                                </div>
